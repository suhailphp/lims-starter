                ...
                >
                  <label className="cursor-pointer">
                    <input
                      ...
                      defaultChecked
                    />
                    <span className="btn border border-gray-200 text-dark rounded-lg tag-btn hover:bg-primary hover:text-white hover:border-primary peer-checked:bg-primary peer-checked:text-white peer-checked:border-primary dark:peer-checked:text-dark!">
                      Paragraphs
                    </span>
                  </label>
                  <label className="cursor-pointer">
        ...
        <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-12 flex">
          ...
          <div className="bg-white dark:bg-dark-card border border-border-color shadow rounded-lg p-5">
            ...
            <div className="flex flex-col justify-center items-center hidden">
              <div className="bg-light rounded-full size-16 flex items-center justify-center mb-5 text-3xl border border-border-color">
            ...
            {/* Generated Text */}
            <div className="copy-text h-[400px] xl:h-[780px] xxl:h-[668px] overflow-y-auto scroll-smooth">
              <div className="flex items-center justify-between mb-5">
                <button className="copy-btn btn border border-gray-200 text-dark rounded-lg tag-btn py-2 flex items-center hover:bg-primary hover:text-white hover:border-primary">
                  {" "}
                  <i className="icon-copy me-2" /> Copy
                </button>
                <p className="mb-0">Total : 600 Words</p>
              </div>
              <div className="mb-5">
                <h4 className="mb-2 text-[16px]">
                  Understanding Explain the importance of cybersecurity for
                  small businesses
                </h4>
                <p className="mb-0">
                  Explain the importance of cybersecurity for small businesses.
                  In today's dynamic landscape, understanding the nuances of
                  Explain the importance of cybersecurity for small businesses
                  is essential for success. This comprehensive guide explores
                  key concepts using everyday language and relatable examples.
                </p>
              </div>
              <div className="mb-5">
                <h4 className="mb-2 text-[16px]"> Core Principles </h4>
                <p className="mb-0">
                  The foundation of any effective strategy begins with clear
                  understanding. By focusing on fundamental principles,
                  organizations can build robust frameworks that drive
                  sustainable growth and innovation.
                </p>
              </div>
              <div className="mb-5">
                <h4 className="mb-2 text-[16px]"> Implementation Strategy</h4>
                <p className="mb-0">
                  Success requires thoughtful planning and execution. Begin with
                  a thorough assessment of current capabilities, then develop a
                  roadmap that aligns with organizational objectives and
                  resources.
                </p>
              </div>
              <div className="mb-5">
                <h4 className="mb-2 text-[16px]">Measuring Success</h4>
                <p className="mb-0">
                  Establish clear metrics and KPIs to track progress. Regular
                  evaluation enables continuous improvement and helps identify
                  opportunities for optimization and growth.
                </p>
              </div>
              <div className="mb-5">
                <h4 className="mb-2 text-[16px]">Future Outlook</h4>
                <p className="mb-0">
                  As the industry evolves, staying ahead requires adaptability
                  and foresight. Invest in learning, embrace innovation, and
                  maintain flexibility to navigate changing conditions
                  successfully.
                </p>
              </div>
              <div className="mb-0">
                <h4 className="mb-2 text-[16px]">Conclusion</h4>
                <p className="mb-0">
                  By applying these insights to Explain the importance of
                  cybersecurity for small businesses, you can achieve
                  exceptional outcomes and maintain competitive advantage in
                  your field.
                </p>
              </div>
            </div>
