        ...
        <div className="flex items-center flex-wrap gap-2 justify-between mb-5">
          <div>
            ...
            <div className="flex items-center flex-wrap gap-2">
              <button className="btn px-2 py-1 bg-light text-dark font-medium text-sm rounded-lg border border-border-color hover:bg-primary transition hover:text-white hover:border-primary">
                Realistic
              </button>
              <button className="btn px-2 py-1 bg-light text-dark font-medium text-sm rounded-lg border border-border-color hover:bg-primary transition hover:text-white hover:border-primary">
                Horizontal 2:1
          ...
          <div className="flex items-center gap-2">
            <button className="w-8 h-8 rounded-full bg-white text-dark border border-border-color cursor-pointer hover:bg-primary hover:text-white hover:border-primary dark:text-dark! transition flex items-center justify-center">
          ...
          <div className="grid xxl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div className="rounded-lg overflow-hidden group relative">
              ...
              <div className="flex items-center flex-col gap-2 absolute bottom-3 end-3 translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300">
                <button className="w-8 h-8 rounded-full bg-white text-dark cursor-pointer hover:bg-primary transition hover:text-white dark:text-dark dark:hover:text-dark! dark:bg-gray-100 flex items-center justify-center">
                  <i className="icon-share-2" />
                </button>
                <button className="w-8 h-8 rounded-full bg-white text-dark cursor-pointer hover:bg-primary transition hover:text-white dark:text-dark dark:hover:text-dark! dark:bg-gray-100 flex items-center justify-center">
                  <i className="icon-download" />
          ...
          >
            ...
            <div className="bg-white dark:bg-dark-card border border-border-color shadow rounded-lg p-5 mt-5">
              ...
              <div className="flex items-center flex-wrap gap-2 justify-between mb-5">
                <div>
                  <p className="mb-2">
                    Prompt : A cute 3D cartoon character floating with pastel
                    bubbles
                  </p>
                  <div className="flex items-center gap-2">
                    <button className="btn px-2 py-1 bg-light text-dark font-medium text-sm rounded-lg border border-border-color hover:bg-primary transition hover:text-white hover:border-primary">
                    ...
                    <button className="btn btn px-2 py-1 bg-light text-dark font-medium text-sm rounded-lg border border-border-color hover:bg-primary transition hover:text-white hover:border-primary">
                      Potrait 2:3
                    </button>
                    <button className="btn btn px-2 py-1 bg-light text-dark font-medium text-sm rounded-lg border border-border-color hover:bg-primary transition hover:text-white hover:border-primary">
                      High
