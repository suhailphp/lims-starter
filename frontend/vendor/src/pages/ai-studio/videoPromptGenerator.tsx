...
const VideoPromptGenerator = () => {
    ...
    navigate(Path.videoGeneratorSuccess);
    ...
    <div className="xxl:col-span-8 xl:col-span-7 lg:col-span-12 flex ">
      ...
      <div className="bg-white dark:bg-dark-card border border-border-color shadow rounded-lg p-5 w-full">
        ...
        <div className="flex flex-col justify-between gap-6 h-[calc(100%-70px)]!">
          {/* Generate text */}
          <div className="flex items-center justify-center flex-col pb-5 mx-auto">
            <div className="bg-light border border-border-color rounded-lg p-5 mb-10">
              <p className="mb-0 text-gray-900">
                Generate a cinematic short video of a futuristic city powered by
                AI, glowing data streams flowing through buildings. Night
                environment with neon lights and volumetric fog.
              </p>
            </div>
            <div className="w-full">
              <div className="text-center mb-6 w-full">
                <h3 className="mb-2 font-bold"> 60% </h3>
                <div className="bg-border-color w-full h-2 rounded-lg">
                  <div
                    className="rounded-lg h-2 bg-primary"
                    style={{ width: "25%" }}
                  />
                </div>
              </div>
              <div className="text-center">
                <h4 className="mb-2 text-[16px]">Generating Video</h4>
                <p className="mb-0">
