          ...
          <div className="flex items-center justify-center flex-col pb-5 w-3/5 mx-auto mt-5">
            <div className="w-full">
              ...
              <div className="text-center">
                <h4 className="mb-2 text-[16px]">Generating Voice....</h4>
                <p className="mb-0">
              ...
              <div className="flex items-center flex-wrap gap-3">
                ...
                <div ref={containerRef} className="relative inline-flex">
                  <button
                    ...
                    aria-haspopup="menu"
                    aria-expanded={isOpen("promptLanguage")}
                    aria-label="Dropdown"
                  >
                    English <i className="icon-chevron-down" />
                  </button>
                  {isOpen("promptLanguage") && (
                    <div
...
export default VoicePromptGenerator