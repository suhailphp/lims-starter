        ...
        <form onSubmit={handleSubmit}>
          <div className="grid md:grid-cols-12 gap-4 mb-5 pb-5 border-b border-border-color">
            <div className="col-span-12">
              ...
              <div className="relative">
                <input
                  ...
                  defaultValue="SEO Blog Post Writer"
                />
              </div>
            </div>
            <div className="lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12">
              ...
              placeholder="Text" // optional // for screen readers
            ...
            <div className="lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-12">
              ...
              placeholder="Marketing" // optional // for screen readers
              className="custom-select" // optional styling
            />
            </div>
            <div className="col-span-12">
              ...
              <textarea
                ...
                rows={3}
                defaultValue={
                  "Generate high-quality blog posts optimized for search engines to increase organic..."
                }
              />
