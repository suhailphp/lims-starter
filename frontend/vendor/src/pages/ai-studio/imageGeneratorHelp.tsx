...
const ImageGeneratorHelp = () => {
  ...
  <div className="bg-white dark:bg-dark-card border border-border-color shadow rounded-lg p-5">
    ...
    <div className="flex items-center justify-between mb-5">
      <h2 className="inline-flex items-center gap-1 text-[16px]">
        {" "}
        <i className="icon-calendar-days font-medium" /> Today
      </h2>
      <a href="#" className="text-sm text-danger hover:text-danger-800">
        Clear All
      </a>
    </div>
    {/* Empty Item  */}
    <div className="flex items-center flex-wrap gap-2 justify-between mb-5">
      <div>
        <p className="mb-2">
          Prompt : A hyper realistic portrait of a young woman with soft
          lighting
        </p>
        <div className="flex items-center flex-wrap gap-2">
          <span className="px-2 py-1 bg-light text-dark font-medium text-sm rounded-lg border border-border-color hover:bg-primary transition hover:text-white hover:border-primary">
            Realistic
          </span>
          <span className="px-2 py-1 bg-light text-dark font-medium text-sm rounded-lg border border-border-color hover:bg-primary transition hover:text-white hover:border-primary">
            Horizontal 2:1
      ...
      <div className="flex items-center gap-2">
        <button className="w-8 h-8 rounded-full bg-white text-dark border border-border-color cursor-pointer hover:bg-light transition dark:text-white flex items-center justify-center">
    ...
    <div className="mb-5 pb-5 border-b border-border-color">
      <div className="grid xxl:grid-cols-3 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6">
        {/* Items 1  */}
        <div className="rounded-lg overflow-hidden relative">
          <ImageWithBasePath
            src={Images.empty_product}
            alt="generate"
    ...
    {/* Today Items  */}
    <div className="mb-5 pb-5 border-b border-border-color">
      <div className="grid xxl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6">
        {/* Items 1  */}
        <div className="rounded-lg overflow-hidden group relative">
          <ImageWithBasePath
            src={Images.generate_img_1}
            alt="generate"
            className="w-full transition-transform duration-500 group-hover:scale-105"
          />
          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          <div className="flex items-center flex-col gap-2 absolute bottom-3 end-3 translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300">
            <button className="w-8 h-8 rounded-full bg-white text-dark cursor-pointer hover:bg-primary transition hover:text-white dark:text-white flex items-center justify-center">
              <i className="icon-share-2" />
            </button>
            <button className="w-8 h-8 rounded-full bg-white text-dark cursor-pointer hover:bg-primary transition hover:text-white dark:text-white flex items-center justify-center">
              <i className="icon-download" />
    ...
    <div className="flex items-center flex-wrap gap-2 justify-between mb-5">
      <div>
        <p className="mb-2">
          Prompt : A premium perfume bottle on a reflective glass surface
        </p>
        <div className="flex items-center flex-wrap gap-2">
          <span className="px-2 py-1 bg-light text-dark font-medium text-sm rounded-lg border border-border-color hover:bg-primary transition hover:text-white hover:border-primary">
            Realistic
  ...
  <div className="hs-accordion active mt-5 pt-5 border-t border-border-color">
    <div className="flex items-center justify-between gap-x-3 w-full">
      <button
        className="hs-accordion-toggle hs-accordion-active:bg-light hs-accordion-active:border-0 inline-flex items-center justify-between gap-x-3 w-full font-semibold text-start text-foreground disabled:pointer-events-none"
        aria-expanded="true"
        aria-controls="acc-4"
      >
        <span className="font-bold text-lg flex items-center gap-2 mb-0 text-dark leading-none">
          History
          <span className="hs-accordion-active:hidden block size-4 ms-auto font-medium">
            <i className="icon icon-chevron-down" />
          </span>
          <span className="hs-accordion-active:block hidden size-4 ms-auto font-medium">
      ...
      <a
        href="#"
        className="text-sm text-danger font-normal hover:text-danger-800 whitespace-nowrap"
      >
        Clear All
      </a>
    </div>
    ...
    >
      {/* History Item  */}
      <div className="bg-white dark:bg-dark-card border border-border-color shadow rounded-lg p-5 mt-5">
        <div className="flex items-center justify-between mb-5">
          <h2 className="inline-flex items-center gap-1 text-[16px]">
            {" "}
            <i className="icon-calendar-days font-medium" /> 25 Nov 2025
          </h2>
        </div>
        <div className="flex items-center flex-wrap gap-2 justify-between mb-5">
          <div>
            <p className="mb-2">
              Prompt : A cute 3D cartoon character floating with pastel bubbles
            </p>
            <div className="flex items-center gap-2">
              <span className="px-2 py-1 bg-light text-dark font-medium text-sm rounded-lg border border-border-color hover:bg-primary transition hover:text-white hover:border-primary">
                Vintage
        ...
        {/* Today Items  */}
        <div className="mb-5 pb-5 border-b border-border-color">
          <div className="grid xxl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6">
            {/* Items 1  */}
            <div className="rounded-lg overflow-hidden group relative">
              <ImageWithBasePath
                src={Images.product_img_4}
                alt="generate"
                className="w-full transition-transform duration-500 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        ...
        <div className="text-center">
          <a
            href="#"
            className="btn bg-white border border-border-color inline-flex items-center gap-2 text-dark font-semibold hover:bg-primary transition hover:text-white hover:border-primary"
          >
            {" "}
            <i className="icon-loader" /> Load Previous
          </a>
        </div>
      </div>
    </div>
...
export default ImageGeneratorHelp