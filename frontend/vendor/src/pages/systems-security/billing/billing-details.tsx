    ...
    <div className="p-6 pb-0">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 lg:grid-cols-12 gap-6 mb-6">
        ...
        <div className="xxl:col-span-10 xxl:col-start-2 xl:col-span-10 xl:col-start-2 lg:col-span-12 lg:col-start-1">
          <div className="bg-white border border-border-color rounded-lg shadow p-5 mb-6">
            ...
            <h5 className="mb-4 text-[16px]">AI Services Provided</h5>
              ...
              <table className="table-auto mb-0 w-full">
                ...
                <tbody className="">
                  <tr className="border-b border-border-color">
                    ...
                    <td className="px-4 py-3 text-start">120 tasks</td>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-start">230 tasks</td>
            ...
            <div className="grid grid-cols-12 gap-6 border-b border-border-color p-5 mb-5 overflow-auto">
              <div className="sm:col-span-6 xxl:col-span-4 col-span-12">
                <h6 className="mb-4">Payment Details</h6>
                <p className="flex items-center justify-between mb-2">
                  <span className="text-dark font-medium">Payment Method:</span>
                  Bank Transfer
                </p>
                <p className="flex items-center justify-between mb-2">
                ...
                <p className="flex items-center justify-between mb-2">
                  <span className="text-dark font-medium">Account Number:</span>
                  1234 5678 9012
                </p>
                <p className="flex items-center justify-between mb-2">
                  <span className="text-dark font-medium">Bank Name:</span>
                  JPMorgan Chase Bank
                </p>
              ...
              <div className="sm:col-span-6 xxl:col-span-4 col-span-12">
                ...
                <p className="flex items-center justify-between mb-2">
                  <span className="text-dark font-medium">Platform fee:</span>
                  $10
                </p>
                <p className="flex items-center justify-between mb-2">
                ...
                <p className="flex items-center justify-between">
                  <span className="text-dark font-medium">In words:</span>
                  Dollars Seven Hundread
                </p>
              </div>
            </div>
            <div className="grid grid-cols-12 gap-4">
              ...
              <div className="sm:col-span-3 col-span-12">
                <div className="flex justify-center sm:items-end items-center flex-col h-full">
                  <ImageWithBasePath src={Images.signature} alt="Signature" />
