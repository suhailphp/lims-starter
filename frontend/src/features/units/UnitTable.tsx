/* DOMAIN — Unit list table.
 * Pattern reference: features/sources/SourceTable.tsx (FK-aware template).
 */
...
export function UnitTable({
  ...
  const skeletonRows: Unit[] = showSkeletons
    ? Array.from({ length: 5 }, (_, i) => ({ unitID: `sk-${i}` }) as unknown as Unit)
    : []
  ...
  return (
    <div className="bg-white rounded-md border border-border-color custom-datatable relative">
      ...
      <div className="px-4 py-3 flex items-center justify-between flex-wrap gap-2 custom-table-header">
        <h5 className="text-[17.5px]">Units</h5>
      ...
      <div className="overflow-x-auto">
        ...
        >
          ...
          <Column
            ...
            className="px-4 py-3 text-start text-dark"
            body={(row: Unit) =>
              showSkeletons ? <Skel w="40%" /> : <span className="font-mono">{row.symbol}</span>
            }
          />
          <Column
            field="createdAt"
        ...
        <div className="sm:col-span-4 col-span-12">
          <div className="flex justify-center sm:block">
            <div className="dt-length">
              <label htmlFor="units-page-size" className="text-sm">
                Show{' '}
                <select
                  id="units-page-size"
                  className="dt-input"
